...
public class TelaUsuarioCadastrarUI extends javax.swing.JFrame {
    ...
    @Autowired
    private TipoUsuarioIController tipoUsuarioController;
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            user.setEmail(email);
            user.setPessoa(pessoa); // associa a pessoa antes de salvar

            boolean sucessoPessoa = pessoaController.save(pessoa);
            boolean sucessoUsuario = usuarioController.save(user);
